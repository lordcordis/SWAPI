...
//        
//        requestVehicleListNetworkResponse(stringURL: nextListUrlString) { vehiclesArray in
//            self.vehicles.append(contentsOf: vehiclesArray.results)
//            self.nextListUrlString = vehiclesArray.next
//            
//        }
//        
//    }
